...
if (isset($_GET["nivel_org"])) {
	$eva = $bd->getEvaluadorDiv($_GET["nivel_org"]);
	$division = $eva["division"];
?>
	<div class="content-wrapper px-4">
					...
					<div class="col-12">
						<div class="d-flex flex-row justify-content-between align-items-center">
							<h2 class="m-0 fw-bold">
								<?= ucfirst(mb_strtolower($division, "UTF-8")) ?>
		...
		?>
			...
			$titulo_graf = "coordinación y/o departamento";
			if (isset($_SESSION['rol'])) {
				$array_dep = $bd->getDepartamentos($eva["id"]);
				$array_coord = $bd->getCoordinaciones($eva["id"]);
				...
				foreach ($q as $q) {
					...
					$jdivision = $bd->getEvaluadorDiv($_GET['nivel_org']);
