				...
				<div class="row">
				  <div class="col-md-4">
                    <div class="form-group">
                      <label for="exampleInputPassword1">EMPLEADO A EVALUAR <?php  //echo "El valor: ".$_SESSION["evaluador"]; //echo $_SESSION['nivel_org']; ?>  </label>
			 ...
			 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr id='mitr<?=$i?>'  style=""  id="celda1" onmouseover='cambiar_color_over(this,<?=$i?>)' onmouseout="cambiar_color_out(this,<?=$i?>)" onClick="vercolor(this,<?=$i?>)">
                    ...
                    <td  align="center" onClick="asignar(<?=$id?>,<?=$idv?>,'<?=$tipo_c?>',<?=$i?>,this)"  >
						<a href="#" class="btn bg-secondary btn-xs" data-toggle="tooltip" data-html="true" data-placement="left" title='<?php echo $tableresult;?>' ><i class="fas fa-edit"><?php echo 'En revisión';?></i></a>
                    ...
                    <td align="center">
                      ...
                      <a href="<?= 'elimina_evaluacion.php?id_eval='.$query['id_eval']; ?>" class="btn bg-gradient-danger btn-xs" onclick="return confirm('Estás seguro que deseas eliminar el registro?');"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
