...
if (isset($_GET["nivel_org"])) {
	$evaluador = $bd->getEvaluadorGer($_GET["nivel_org"]);
	$gerencia = $evaluador["gerencia"];
?>
	<div class="content-wrapper px-4">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-4">
					<div class="col-12">
						<h2 class="m-0 fw-bold"><?= ucfirst(mb_strtolower($gerencia, "UTF-8")) ?></h2>
...
<?php
	if ($evaluador) {
		...
		if (isset($_SESSION['id_perfil']) && $_SESSION["id_perfil"] <> 5) {
				$href = '';				
				if ($_GET["nivel_org"] == '2000') {
					$titulo_graf = "Gerencias Operativas";
					$href = "detalles.php?d=6&nivel_org=";
					$q = $bd->getGerenciasOp($evaluador["cedula"], 1);
				} 
				else {
					$titulo_graf = "División";
					$href = "detalles.php?d=2&nivel_org=";
